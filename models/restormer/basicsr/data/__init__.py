...
from .paired_image_dataset import Dataset_PairedImage
...
def create_dataset(dataset_opt):
    ...
    """
    if dataset_opt['type'] == 'PairedDataset':
        from basicsr.data.paired_image_dataset import PairedDataset
        dataset = PairedDataset(dataset_opt)
        return dataset
