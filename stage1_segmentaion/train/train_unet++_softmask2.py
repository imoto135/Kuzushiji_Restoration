...
def parse_args():
    ...
    # 【変更】保存パスを head_dropout 実験用に変更
    parser.add_argument('--save-path', type=str, default='Kuzushiji_Restoration/experiments/segmentation/ablation/head_dropout/best.pth')
    parser.add_argument('--log-path', type=str, default='Kuzushiji_Restoration/experiments/segmentation/ablation/head_dropout/train.log')
    ...
    parser.add_argument('--head-dropout', type=float, default=0.5, help='Dropout rate before segmentation head (0.0 to disable)')
