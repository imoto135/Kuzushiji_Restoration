...
Restormer（論文メインモデル）の損傷タイプ別評価。条件: (a) 入力画像、(b) Baseline（マスクなし）、(c) Ours・提案手法（予測マスク）、(d) Ideal・理論上限（正解マスク）

| 条件 | PSNR↑ | SSIM↑ | LPIPS↓ | M-PSNR↑ | M-SSIM↑ |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **(a) Input（修復前）** | 21.33 | 0.811 | 0.321 | 18.80 | 0.720 |
| **(b) Baseline（NoMask）** | 38.21 | 0.970 | 0.031 | 34.65 | 0.967 |
| **(c) Ours（PredMask）** | 36.54 | 0.965 | **0.032** | 32.48 | 0.957 |
| **(d) Ideal（GTMask）** | **38.88** | **0.970** | **0.024** | **35.57** | **0.973** |

<details>
<summary>損傷タイプ別詳細（クリックで展開）</summary>

**Baseline (b) — NoMask**

| 損傷タイプ | PSNR↑ | SSIM↑ | LPIPS↓ | M-PSNR↑ | M-SSIM↑ |
| :--- | :---: | :---: | :---: | :---: | :---: |
| Missing | 34.25 | 0.958 | 0.042 | 30.31 | 0.943 |
| Abrasion | 38.55 | 0.965 | 0.036 | 35.89 | 0.976 |
| Stain | 34.32 | 0.959 | 0.041 | 30.40 | 0.943 |
| Ghosting | 42.23 | 0.985 | 0.016 | 38.45 | 0.985 |
| Transparent Stain | 42.12 | 0.984 | 0.016 | 38.61 | 0.987 |

**Ours (c) — PredMask（提案手法）**

| 損傷タイプ | PSNR↑ | SSIM↑ | LPIPS↓ | M-PSNR↑ | M-SSIM↑ |
| :--- | :---: | :---: | :---: | :---: | :---: |
| Missing | 33.72 | 0.956 | **0.041** | 29.36 | 0.937 |
| Abrasion | 37.56 | 0.963 | **0.034** | 34.19 | 0.968 |
| Stain | 34.01 | 0.957 | **0.040** | 29.76 | 0.940 |
| Ghosting | 42.06 | 0.985 | **0.015** | 38.22 | 0.985 |
| Transparent Stain | 35.73 | 0.965 | 0.031 | 31.28 | 0.956 |

**Ideal (d) — GTMask（理論上限）**

| 損傷タイプ | PSNR↑ | SSIM↑ | LPIPS↓ | M-PSNR↑ | M-SSIM↑ |
| :--- | :---: | :---: | :---: | :---: | :---: |
| Missing | 38.87 | 0.968 | 0.023 | 35.92 | 0.974 |
| Abrasion | 38.69 | 0.965 | 0.032 | 36.35 | 0.978 |
| Stain | 39.03 | 0.969 | 0.022 | 36.00 | 0.974 |
| Ghosting | 42.45 | 0.985 | 0.015 | 38.66 | 0.986 |
| Transparent Stain | 35.49 | 0.963 | 0.030 | 30.97 | 0.953 |

</details>

> **考察**: Missing・Abrasion・Stain・Ghostingで提案手法(c)がBaselineを LPIPS で上回り、マスクガイドの有効性を確認。Transparent Stain は背景との境界が曖昧で、マスクが背景汚れ除去の妨げとなるケースがあり今後の課題。

---

### 🏆 モデル横断比較（full_padded データセット）
...
### 🌀 MambaIR 評価（hiragana_fulldataset_5stain）

State Space Model ベースの **MambaIR** を5種劣化データセット（`hiragana_fulldataset_5stain`）で評価した結果です。
